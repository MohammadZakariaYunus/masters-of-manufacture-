...
const Header = () => {
    ...
    const menuItem = <>
        ...
        <li className='text-lg text-white'><Link as={Link} to="/services">Services</Link></li>
        <li className='text-lg text-white'><Link as={Link} to="/dashboard">Dashboard</Link></li>
        ...
        <div>
            <div class="navbar bg-primary">
                <div class="navbar-start">
                    ...
                    <a class="btn btn-ghost normal-case text-xl text-white">Masters of Manufacture</a>
                </div>
                ...
                <div class="navbar-end">
                    ...
                    <Link className="btn" as={Link} to="/login">Login</Link>
